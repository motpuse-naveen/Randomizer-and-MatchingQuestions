...
jquery.src = '../../assets/image_zoom/jquery-3.1.1.min.js';
...
jqueryui.src = '../../assets/image_zoom/jquery-ui.js';
document.head.appendChild(jqueryui);

var main = document.createElement('script');
main.type = 'text/javascript';
main.src = '../../assets/image_zoom/main.js';
document.head.appendChild(main);

var iscroll = document.createElement('script');
iscroll.type = 'text/javascript';
iscroll.src = '../../assets/image_zoom/iscroll-zoom.js';
document.head.appendChild(iscroll);
...
var touchPunch = document.createElement('script');
touchPunch.type = 'text/javascript';
touchPunch.src = '../../assets/image_zoom/jquery.ui.touch-punch.min.js';
document.head.appendChild(touchPunch);

var scale = document.createElement('script');
scale.type = 'text/javascript';
scale.src = '../../assets/image_zoom/scale.js';
document.head.appendChild(scale);

var style = document.createElement('link');
style.rel = 'stylesheet';
style.href = '../../assets/css/zoom.css';
