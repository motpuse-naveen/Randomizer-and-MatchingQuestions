var QuestionController = function(obj) {
    ...
    function setupQuestionObjects(data) {
        ...
        if (Const.mode == 'exam') {
            ...
            oQueHtml.append('<ul id="examList"><li><div id="mainListDiv"><div class="resultHeading tabindex">' + mode + ' > ' + Const.selected_section +' > Exam ' + (Const.examSeq[Const.currentSet]) + ' > Section ' + currentSection + ' of ' + totalSection + '</div></div></li></ul>');
            buttonContainer = $('<div>', {
                class: 'button-container'
            });
        } else {
            var mode = "Study Mode";
            oQueHtml.append('<ul id="examList"><li><div id="mainListDiv"><div class="resultHeading tabindex">' + mode + ' > ' + Const.selected_section + ' > Exam ' + (Const.examSeq[Const.currentSet]) + '</div></div></li></ul>');
            buttonContainer = $('<div>', {
                class: 'button-container'
            });
        }
    ...
    function loadQuestion(num) {
		...
		oActivity = new window[arr[num]['@activityType']](arr[num], num+1, arr.length);
