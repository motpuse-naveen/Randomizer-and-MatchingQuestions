(function(app) {
    ...
    app.loName;
    app.searchKeyword;
    app.topTitle1 = "Eric Williams and Lindsay Moskowitz's";
    app.topTitle2 = "Kaplan & Sadock's Study Guide and Self-Examination Review in Psychiatry";
    app.authorName = '';
    app.editionText = '';
    app.bottomDivText = '';
